from match_help import match_help, pooling
import torch
import pandas as pd
import os
...
pooling_choice = 'max'
feature_file = '/OSM/CBR/D61_XTLAN/work/wan305/iccv_feature/1st_pred/hmdb_s1_tr_pred_48.pth'
f1 = '/flush1/wan305/data/TrainTestSplit/hmdb_train_split_01_peter_48_step_8_samp_1_num_clip_label_tr.csv'
f2 = '/flush1/wan305/data/TrainTestSplit/hmdb_train_split_01_peter_48_step_8_samp_2_num_clip_label_tr.csv'
f3 = '/flush1/wan305/data/TrainTestSplit/hmdb_train_split_01_peter_48_step_8_samp_3_num_clip_label_tr.csv'
# f4 = '/flush1/wan305/data/TrainTestSplit/hmdb_train_split_01_peter_64_step_8_samp_4_num_clip_label_tr.csv'
...
x, num_clip_list = match_help(feature_file, f1, f2, f3)
# print(num_clip_list)
