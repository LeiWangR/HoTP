...
class TwoStreamNet(nn.Module):
    def __init__(self):
        ...
        self.ln = nn.LayerNorm([1024, 24, 7, 7])
...
tr_info_list = '/flush1/wan305/data/TrainTestSplit/yup_mixed_train_split01_peter_96.csv'
te_info_list = '/flush1/wan305/data/TrainTestSplit/yup_mixed_test_split01_peter_96.csv'
...
#------------------------
num_clip_label1 = pd.read_csv('/flush1/wan305/data/TrainTestSplit/yup_static_test_split01_peter_96_num_clip_label.csv', header=None)
num_clip_label2 = pd.read_csv('/flush1/wan305/data/TrainTestSplit/yup_moving_test_split01_peter_96_num_clip_label.csv', header=None)
...
state_dict = torch.load('/flush3/wan305/Lei_trained_model/yup_mixed_two_stream_split1_96.pt')
...
for i in range(num_epochs):
    ...
    torch.save(net.state_dict(), '/flush3/wan305/Lei_trained_model/yup_mixed_two_stream_split1_96_new.pt')
    # Testing---------------------------------
