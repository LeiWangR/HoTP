...
#------------------------
num_clip_label = pd.read_csv('/flush1/wan305/data/TrainTestSplit/yup_static_test_split01_peter_64_num_clip_label.csv', header=None)
...
for i in range(num_epochs):
    ...
    torch.save(net.state_dict(), '/flush3/wan305/Lei_trained_model/yup_s_two_stream_split1_64.pt')
    # Testing---------------------------------
