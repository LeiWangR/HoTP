...
te_info_list = '/flush1/wan305/data/TrainTestSplit/yup_static_test_split01.csv'
...
str_name = te_info_list[: -4] + '_peter_'+ str(sub_N) + '_step_' + str(stride) + '_samp_'+str(sample)+'.csv'
...
str_name = te_info_list[: -4] + '_peter_'+ str(sub_N) + '_step_' + str(stride) + '_samp_'+str(sample)+'_num_clip_label.csv'
