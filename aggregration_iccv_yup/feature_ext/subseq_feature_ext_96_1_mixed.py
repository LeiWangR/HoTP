...
state_dict = torch.load('/flush3/wan305/Lei_trained_model/yup_mixed_two_stream_split1_96_new.pt')
...
for i in range(num_epochs):
    ...
    with torch.no_grad():    
        ...
        torch.save(x_pred_tensor, '/flush2/wan305/yup_mixed_s1_tr_pred_96.pth')
    ...
    with torch.no_grad():
        ...
        print('x_pred_tensor saved', x_pred_tensor.shape)
        # torch.save(x_p_tensor, '/flush2/wan305/hmdb_s1_te_pool_64.pth')
        torch.save(x_pred_tensor, '/flush2/wan305/yup_mixed_s1_te_pred_96.pth')
