...
for i in range(num_epochs):
    ...
    with torch.no_grad():    
        ...
        torch.save(x_p_tensor, '/flush3/wan305/yup_mixed_s1_tr_pool_96_m.pth')
    ...
    with torch.no_grad():
        ...
        print('x_p_tensor saved', x_p_tensor.shape)
        # torch.save(x_p_tensor, '/flush2/wan305/hmdb_s1_te_pool_64.pth')
        torch.save(x_p_tensor, '/flush3/wan305/yup_mixed_s1_te_pool_96_m.pth')
