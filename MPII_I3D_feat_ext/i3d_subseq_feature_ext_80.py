...
for i in range(num_epochs):
    ...
    with torch.no_grad():    
        ...
        torch.save(x_rgb_tensor, '/flush2/wan305/MPII_IJCV/Raw_400D/mpii_pred_80_rgb.pth')
        torch.save(x_opt_tensor, '/flush2/wan305/MPII_IJCV/Raw_400D/mpii_pred_80_opt.pth')
