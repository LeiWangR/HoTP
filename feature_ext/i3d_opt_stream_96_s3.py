...
#----------------------------------------------
# dataset
tr_info_list = '/flush2/wan305/MPII_IJCV/tr_te_split/mpii_info_list_with_subject_for_split_peter_96_tr_sp3.csv'
te_info_list = '/flush2/wan305/MPII_IJCV/tr_te_split/mpii_info_list_with_subject_for_split_peter_96_te_sp3.csv'
...
state_dict = torch.load('/flush3/wan305/Lei_trained_model/mpii_s3_opt_96.pt')
...
for i in range(num_epochs):
    ...
    with torch.no_grad():
        x_pred_tensor = torch.cuda.FloatTensor(1, 64).fill_(0)
        for t, sample_batched in enumerate(train_dataloader):
            ...
            y_pred = net(opt_video)
            x_pred_tensor = torch.cat((x_pred_tensor, y_pred), 0)
        ...
        print('x_pred_tensor saved', x_pred_tensor.shape)
        torch.save(x_pred_tensor, '/flush3/wan305/mpii_s3_tr_opt_finetuned_64D_96.pth')

# print('epoch: ', i, '', 'batch_id: ',t, 'Classifi. loss: %.5f' % pred_loss.item())

#    torch.save(net.state_dict(), '/flush3/wan305/Lei_trained_model/mpii_s1_opt_48.pt')
#    # Testing---------------------------------
#    net.eval()
#    correct = 0
#    total = 0
    with torch.no_grad():
        ...
        x_pred_tensor = x_pred_tensor[1:, :]
        print('x_pred_tensor saved', x_pred_tensor.shape)
        torch.save(x_pred_tensor, '/flush3/wan305/mpii_s3_te_opt_finetuned_64D_96.pth')
