...
state_dict = torch.load('/flush3/wan305/Lei_trained_model/mpii_s4_rgb_96.pt')
...
# print('epoch: ', i, '', 'batch_id: ',t, 'Classifi. loss: %.5f' % pred_loss.item())
        ...
        torch.save(x_pred_tensor, '/flush3/wan305/mpii_s4_tr_rgb_finetuned_64D_96.pth')
...
# total = 0
    with torch.no_grad():
        ...
        x_pred_tensor = x_pred_tensor[1:, :]
        print('x_pred_tensor saved', x_pred_tensor.shape)
        torch.save(x_pred_tensor, '/flush3/wan305/mpii_s4_te_rgb_finetuned_64D_96.pth')
