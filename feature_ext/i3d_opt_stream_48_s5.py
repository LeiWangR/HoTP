...
#----------------------------------------------
# dataset
tr_info_list = '/flush2/wan305/MPII_IJCV/tr_te_split/mpii_info_list_with_subject_for_split_peter_48_tr_sp5.csv'
te_info_list = '/flush2/wan305/MPII_IJCV/tr_te_split/mpii_info_list_with_subject_for_split_peter_48_te_sp5.csv'
...
state_dict = torch.load('/flush3/wan305/Lei_trained_model/mpii_s5_opt_48.pt')
...
for i in range(num_epochs):
    ...
    with torch.no_grad():
        ...
        torch.save(x_pred_tensor, '/flush3/wan305/mpii_s5_tr_opt_finetuned_64D_48.pth')
...
#    total = 0
    with torch.no_grad():
        ...
        x_pred_tensor = x_pred_tensor[1:, :]
        print('x_pred_tensor saved', x_pred_tensor.shape)
        torch.save(x_pred_tensor, '/flush3/wan305/mpii_s5_te_opt_finetuned_64D_48.pth')
