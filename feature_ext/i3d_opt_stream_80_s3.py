...
#----------------------------------------------
# dataset
tr_info_list = '/flush2/wan305/MPII_IJCV/tr_te_split/mpii_info_list_with_subject_for_split_peter_80_tr_sp3.csv'
te_info_list = '/flush2/wan305/MPII_IJCV/tr_te_split/mpii_info_list_with_subject_for_split_peter_80_te_sp3.csv'
...
state_dict = torch.load('/flush3/wan305/Lei_trained_model/mpii_s3_opt_80.pt')
...
for i in range(num_epochs):
    ...
    with torch.no_grad():
        ...
        torch.save(x_pred_tensor, '/flush3/wan305/mpii_s3_tr_opt_finetuned_64D_80.pth')
...
#    total = 0
    with torch.no_grad():
        ...
        x_pred_tensor = x_pred_tensor[1:, :]
        print('x_pred_tensor saved', x_pred_tensor.shape)
        torch.save(x_pred_tensor, '/flush3/wan305/mpii_s3_te_opt_finetuned_64D_80.pth')
