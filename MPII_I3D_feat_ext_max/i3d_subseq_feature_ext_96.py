...
#----------------------------------------------
# dataset
tr_info_list = '/flush2/wan305/MPII_IJCV/mpii_info_list_with_subject_for_split_peter_96.csv'
...
for i in range(num_epochs):
    ...
    with torch.no_grad():    
        ...
        torch.save(x_rgb_tensor, '/flush2/wan305/MPII_IJCV/Raw_400D/mpii_pred_96_rgb_m.pth')
        torch.save(x_opt_tensor, '/flush2/wan305/MPII_IJCV/Raw_400D/mpii_pred_96_opt_m.pth')
